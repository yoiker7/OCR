...
def demoToTxt0(image_folder, saved_model, txtFile):    # sensitive
    ...
    parser.add_argument('--PAD', default=False, action='store_true', help='whether to keep ratio then pad for image resize')
    """ Model Architecture """
...
if __name__ == "__main__":
    ...
    saved_model = 'saved_models/TPS-ResNet-BiLSTM-Attn-Seed1111/PreTrain/0.5sensitive_best_accuracy.pth'
    txtFile = 'testTxt0.txt'
    demoToTxt0(image_folder, saved_model, txtFile)